...
const Footer: React.FC<FooterProps> = ({ registerFooterSection }) => {
  ...
  Pobierz naszą aplikację na swój telefon.
            ...
            <p className="w-10 h-10 rounded-lg flex items-center justify-center transition-all hover:scale-110 border-2" style={{ color: '#D4AF37' }}>Wpisz ten numer K005533, żebym mógł mieć Twoją sprawę zawsze pod opieką! </p>
<div className="flex space-x-4">
  <a

  ...
  return (
    <footer ref={footerRef} className="py-12 border-t" style={{ backgroundColor: '#0A1A2F', color: '#F5F5F5', borderColor: 'rgba(212, 175, 55, 0.2)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8">
          ...
          <div className="flex justify-center md:justify-start space-x-12 mb-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center transition-all hover:scale-110 border-4" style={{ backgroundColor: '#F5F5F5', borderColor: '#D4AF37' }}
        ...
        {/* Bottom Section */}
        <div className="mx-10 py-8" style={{ borderTop: '1px solid rgba(212, 175, 55, 0.3)' }}>

...
const NewsArticleDetailModal: React.FC<NewsArticleDetailModalProps> = ({ article, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 id="news-article-modal-title" className="text-3xl font-bold mb-6" style={{ color: '#F5F5F5' }}>
          {article.title}
        </h2>

...
import { Phone, Mail, MapPin, CheckCircle, Scale, Users, Award, TrendingUp, Star, Calendar, MessageCircle, Shield } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validate()) {
      // Send to webhook (NO Calendly redirection for contact form)
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0A1A2F' }}>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-7xl font-bold mb-6 leading-tight" style={{ color: '#F5F5F5' }}>
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed" style={{ color: '#F5F5F5' }}>
            ...
            Bezpłatna konsultacja i analiza Twojej umowy.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#0A1A2F' }}>
              Pomagam klientom w unieważnianiu nieuczciwych umów kredytowych i odzyskiwaniu należnych środków
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl shadow-xl border-4 transition-all duration-300 hover:scale-105 hover:shadow-2xl" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}>
              ...
              <p className="text-lg leading-relaxed mb-6 text-center" style={{ color: '#F5F5F5' }}>
                ...
                Pomoc w odzyskaniu nadpłaconych kwot i uzyskaniu korzystnych rozliczeń.
              </p>
            ...
            <div className="p-8 rounded-2xl shadow-xl border-4 transition-all duration-300 hover:scale-105 hover:shadow-2xl" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}>
              ...
              <p className="text-lg leading-relaxed mb-6 text-center" style={{ color: '#F5F5F5' }}>
                Reprezentacja w sprawach umów sprzedaży konsumenckiej na odległość. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#F5F5F5' }}>
              30 lat doświadczenia w biznesie i specjalizacja w sprawach kredytowych
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-2xl shadow-lg border-2" style={{ backgroundColor: '#F5F5F5', borderColor: '#D4AF37' }}>
              <Users size={48} style={{ color: '#0A1A2F' }} className="mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#0A1A2F' }}>Doświadczenie</h3>
              <p style={{ color: '#0A1A2F' }}>30 lat w biznesie i zarządzaniu projektami</p>
            </div>
            
            <div className="text-center p-6 rounded-2xl shadow-lg border-2" style={{ backgroundColor: '#F5F5F5', borderColor: '#D4AF37' }}>
              <Award size={48} style={{ color: '#0A1A2F' }} className="mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#0A1A2F' }}>Specjalizacja</h3>
              <p style={{ color: '#0A1A2F' }}>Ekspert w sprawach kredytów walutowych</p>
            </div>
            
            <div className="text-center p-6 rounded-2xl shadow-lg border-2" style={{ backgroundColor: '#F5F5F5', borderColor: '#D4AF37' }}>
              <TrendingUp size={48} style={{ color: '#0A1A2F' }} className="mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#0A1A2F' }}>Skuteczność</h3>
              <p style={{ color: '#0A1A2F' }}>Wysokie wskaźniki wygranych spraw</p>
            </div>
            
            <div className="text-center p-6 rounded-2xl shadow-lg border-2" style={{ backgroundColor: '#F5F5F5', borderColor: '#D4AF37' }}>
              <Star size={48} style={{ color: '#0A1A2F' }} className="mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#0A1A2F' }}>Zaufanie</h3>
              <p style={{ color: '#0A1A2F' }}>Zadowoleni klienci i pozytywne opinie</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact-section" className="py-20" style={{ backgroundColor: '#F5F5F5' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {showSuccessMessage ? (
            <div className="text-center py-12 p-8 rounded-2xl shadow-xl border-4" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}>
              <CheckCircle size={64} style={{ color: '#D4AF37' }} className="mx-auto mb-4" />
              <h3 className="text-3xl font-bold mb-4" style={{ color: '#F5F5F5' }}>
            ...
            <div className="p-8 rounded-2xl shadow-xl border-4" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}>
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="contact-firstName" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                  ...
                  <div>
                    <label htmlFor="contact-lastName" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                ...
                <div>
                  <label htmlFor="contact-email" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                ...
                <div>
                  <label htmlFor="contact-phone" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                ...
                <div>
                  <label htmlFor="contact-message" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                ...
                {loanType === 'currency' && (
                  <>
                    ...
                    <div>
                      <label htmlFor="contact-agreementDate" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                        Data zawarcia umowy
                      </label>
                      <DatePicker
                        id="contact-agreementDate"
                    ...
                    {/* Original bank */}
                    <div>
                      <label htmlFor="contact-originalBank" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                        Bank pierwotny
                      </label>
                      <select
                        id="contact-originalBank"
                        name="originalBank"
                        value={originalBank}
                    ...
                    {/* Loan currency */}
                    <div>
                      <label htmlFor="contact-loanCurrency" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                        Waluta kredytu
                      </label>
                      <select
                        id="contact-loanCurrency"
                        name="loanCurrency"
                        value={loanCurrency}
                    ...
                    {/* Value in PLN */}
                    <div>
                      <label htmlFor="contact-loanValuePln" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                        Wartość kredytu w PLN (w momencie zawarcia umowy)
                      </label>
                      <input
                        type="text"
                        inputMode="decimal"
                        id="contact-loanValuePln"
                        name="loanValuePln"
                        value={loanValuePln}
                    ...
                    <div>
                      <label htmlFor="contact-numberOfInstallments" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                        Liczba rat w miesiącach (zgodnie z umową)
                      </label>
                      <input
                        type="text"
                        inputMode="numeric"
                        id="contact-numberOfInstallments"
                    ...
                    {loanStatus === 'repaid' && (
                      <>
                        ...
                        <div>
                          <label htmlFor="contact-repaymentDate" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                            Data spłaty kredytu
                          </label>
                          <DatePicker
                            id="contact-repaymentDate"
                        ...
                        <div>
                          <label htmlFor="contact-repaymentValuePln" className="block text-sm font-medium mb-2" style={{ color: '#F5F5F5' }}>
                            Wartość spłaty w PLN
                          </label>
                          <input
                            type="text"
                            inputMode="decimal"
                            id="contact-repaymentValuePln"
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl shadow-lg border-2" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}>
              <Phone size={32} style={{ color: '#D4AF37' }} className="mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#F5F5F5' }}>Telefon</h3>
              <p style={{ color: '#F5F5F5' }}>+48 601 227 876</p>
            </div>
            
            <div className="text-center p-6 rounded-2xl shadow-lg border-2" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}>
              <Mail size={32} style={{ color: '#D4AF37' }} className="mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#F5F5F5' }}>Email</h3>
              <p style={{ color: '#F5F5F5' }}>krzysztof.milewski@dsa.pl</p>
            </div>
            
            <div className="text-center p-6 rounded-2xl shadow-lg border-2" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}>
              <Calendar size={32} style={{ color: '#D4AF37' }} className="mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#F5F5F5' }}>Godziny pracy</h3>
              <p style={{ color: '#F5F5F5' }}>Pon-Pt: 9:00-17:00</p>
            </div>
          </div>
        </div>
      </section>

      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-8 text-lg leading-relaxed rounded-2xl shadow-lg border-4 overflow-hidden" style={{ backgroundColor: '#0A1A2F', borderColor: '#D4AF37' }}> {/* Container for main content, left-aligned */}
              {/* Experience Section */}
              <p>
